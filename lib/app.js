...
App.prototype.startLocalServer = function() {
  ...
  api_request.checkCredentials(function(){
    ...
    var s = new Server(_this.appId, _this.public_folder);
...
App.prototype.uploadFolder = function(comment) {
  ...
  api_request.checkCredentials(function(){
    if (exists_index){
      api_request.uploadFolder(_this.public_folder, comment);
    }
    else {
...
App.prototype.downloadFolder = function() {
  ...
  api_request.checkCredentials(function(){
    api_request.downloadFolder(
      _this.createStamplayJson.bind(_this, process.cwd() + '/' + _this.appId)
    );
  })
};
...
App.prototype.init = function(path) {
  ...
  this.askToUser(schema, function(){
    ...
    api_request.checkCredentials(function(){
      try{
        _this.createStamplayJson(process.cwd());
      } catch(e) {
 ...
 *  Create stamplay.json with app credentials
 */
App.prototype.createStamplayJson = function(path) {
  var data = {};

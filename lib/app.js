...
App.prototype.startLocalServer = function(argv) {
  ...
  api_request.checkCredentials(function(){
    ...
    var s = new Server(_this.appId, _this.public_folder, argv)
...
App.prototype.downloadFolder = function(argv) {
  ...
  api_request.checkCredentials(function(){
    api_request.downloadFolder(
      _this.createStamplayJson.bind(_this, process.cwd() + '/' + _this.appId, argv)
    )
  })
}
 ...
 *  Create stamplay.json with app credentials
 */
App.prototype.createStamplayJson = function(path, argv) {
  var data = {}
